...
if os.path.isdir('/afs/cs.cmu.edu/academic/class/18600-s18/gem5'):
    GEM5_DIR = '/afs/cs.cmu.edu/academic/class/18600-s18/gem5'
...
def run_system_with_cpu(
    ...
    if warmup:
        eprint("Running warmup with warmup CPU class ({} instrs.)".format(warmup_instructions))
